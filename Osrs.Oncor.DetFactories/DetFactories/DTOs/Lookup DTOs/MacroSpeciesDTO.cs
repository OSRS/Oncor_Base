...
{
    public class MacroSpeciesDTO : BaseDTO, IKeyed
    {
        public string Key { get; set; }
        public string Name { get; set; }

        public MacroSpeciesDTO()
        {
        }

        public MacroSpeciesDTO(Dictionary<string, string> values)
        {
        ...
        {
            Schema schema = new Schema(SchemaType.LookupSchema, "fish species");
