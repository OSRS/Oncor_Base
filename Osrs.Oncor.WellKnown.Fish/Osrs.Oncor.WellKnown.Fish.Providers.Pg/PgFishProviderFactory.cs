...
{
    public sealed class PgFishProviderFactory : FishProviderFactoryBase
    {
        public override ICatchEffortProvider GetCatchEffortProvider(UserSecurityContext context)
        {
            return new PgCatchEffortProvider(context);
        }

        public override ICatchHaulProvider GetCatchHaulProvider(UserSecurityContext context)
        {
            return new PgCatchHaulProvider(context);
        }

        public override IFishProvider GetFishProvider(UserSecurityContext context)
        {
            return new PgFishProvider(context);
        }
        ...
        public PgFishProviderFactory()
        {
            instance = this;
        }

        private readonly Type myType = typeof(PgFishProviderFactory);
        private bool initialized = false;
        private LogProviderBase logger;

        private static PgFishProviderFactory instance;
        public static PgFishProviderFactory Instance
        {
            get { return instance; }
        }
    }
