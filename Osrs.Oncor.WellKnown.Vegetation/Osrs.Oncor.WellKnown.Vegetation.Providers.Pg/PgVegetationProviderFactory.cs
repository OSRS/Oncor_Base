...
{
    public sealed class PgVegetationProviderFactory : VegetationProviderFactoryBase
    {
        ...
        public override IVegSurveyProvider GetSurveyProvider(UserSecurityContext context)
        {
            return new PgVegSurveyProvider(context);
        }

        public override IVegSampleProvider GetSampleProvider(UserSecurityContext context)
        {
            return new PgVegSampleProvider(context);
        }

        public PgVegetationProviderFactory()
        {
            instance = this;
        }

        private readonly Type myType = typeof(PgVegetationProviderFactory);
        private bool initialized = false;
        private LogProviderBase logger;

        private static PgVegetationProviderFactory instance;
        public static PgVegetationProviderFactory Instance
        {
            get { return instance; }
        }
    }
